...
[taxonomies]
tags = ["call for papers","fictional games","special issue"]
...
+++
<div class="centered">{{ display_image(path="static/images/fictional-games.jpg", width=750, op="fit_width") }}</div>
...
Fictional games are playful activities and ludic artefacts that were specifically created as part of fictional worlds (or that otherwise originated in fiction). As examples, think of the titular Hunger Games, or Holo-chess in the fictional universe of _Star Wars_. 
...
For the full submission guidelines, see the official _Eludamos_ guidelines for authors available at: [https://www.eludamos.org/index.php/eludamos/information/authors](https://www.eludamos.org/index.php/eludamos/information/authors)

The Eludamos style-guide is available here: [https://www.dropbox.com/scl/fi/aagitrpmd0ipqam9u7ycq/Eludamos-Style-Guide-2023.docx?dl=0&rlkey=g0rbegwlu4ol7bhcshihraj7c](https://www.dropbox.com/scl/fi/aagitrpmd0ipqam9u7ycq/Eludamos-Style-Guide-2023.docx?dl=0&rlkey=g0rbegwlu4ol7bhcshihraj7c)
...
Please use the online submission system for all correspondence with the guest editors and editors: [https://septentrio.uit.no/index.php/eludamos/submission/wizard](https://septentrio.uit.no/index.php/eludamos/submission/wizard)

### About _Eludamos_

_Eludamos_ is an open-access international, interdisciplinary, peer-reviewed journal dedicated to the academic study of computer games and play. The journal is indexed in Scopus and DOAJ. See a complete description of _Eludamos_ and its objectives at [https://eludamos.org/index.php/eludamos/about](https://eludamos.org/index.php/eludamos/about).