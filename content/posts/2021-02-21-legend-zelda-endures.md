...
+++
<div class="centered">{{ display_image(path="static/images/loz0.jpg", width=750, op="fit_width") }}</div>
...
<div class="centered">{{ display_image(path="static/images/loz1.jpg", width=750, op="fit_width") }}</div>
...
<div class="centered">{{ display_image(path="static/images/loz2.png", width=750, op="fit_width") }}</div>
