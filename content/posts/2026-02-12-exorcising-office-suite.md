...
> *This is the second of my blog posts detailing how I am and have been trying to remove big tech from my life. Read the introductory post first: [Exorcising Big Tech](/posts/exorcising-big-tech). Also check out my posts on switching [operating systems](/posts/exorcising-operating-system), [reference managers](/posts/exorcising-reference-manager) and [web browsers](/posts/exorcising-web-browser).*
