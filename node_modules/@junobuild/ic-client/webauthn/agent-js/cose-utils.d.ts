 ...
 */
export declare function _authDataToCose(authData: Uint8Array): Uint8Array;
export declare function _coseToDerEncodedBlob(cose: Uint8Array): DerEncodedPublicKey;
