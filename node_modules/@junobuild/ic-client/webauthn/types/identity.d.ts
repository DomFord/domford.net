 ...
 */
export type RetrievePublicKeyFn = (params: {
    credentialId: Uint8Array;
}) => Promise<CoseEncodedKey>;
/**
 ...
 */
export type CreateWebAuthnIdentityWithNewCredentialArgs = AuthenticatorOptions<CreatePasskeyOptions> & WebAuthnSignProgressArgs;
/**
 * Args for retrieving an existing passkey and initializing a new WebAuthn identity..
 */
export type CreateWebAuthnIdentityWithExistingCredentialArgs = AuthenticatorOptions<PasskeyOptions> & {
